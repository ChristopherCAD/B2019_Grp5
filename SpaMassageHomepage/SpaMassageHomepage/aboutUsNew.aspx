<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aboutUsNew.aspx.cs" Inherits="SpaMassageHomepage.aboutUsNew" %>
      ...
      <div class="homepage">
          <div class="about" style="background-color: white;">
                ...
                <div class="divBody">
                    ...
                    <img id="aboutUsImg"src="imgs/logo22.png" />
                    <h2> About Us</h2>
                    <h1> NORU MASSAGE</h1>
                    ...
                    <div class="row mt-3">
                      ...
                      <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <hr
                            ...
                            />
                        <p>
                          <a href="#!" class="text-dark">MONDAY - SUNDAY</a>
                        </p>
                        <p>
                          <a href="#!" class="text-dark"> 12pm - 8pm</a>
                        </p>
                      </div>
                      <!-- Grid column -->
